...
import type { TlsConnectionSecurityOptions } from '../connection-security-options';
import type { ListenOptions } from 'node:net';
import type { Server, TlsOptions } from 'node:tls';
...
export class TlsServerPhysicalLayer extends AbstractPhysicalLayer {
  ...
  override open(options: ListenOptions, cb?: (err: Error | null) => void): void {
    ...
    const server = createServer(this._tlsOpts ?? {}, (socket) => {
      ...
      const pipeline = new TlsPipelineLayer(this, socket, this._idleTimeout);
